# Rohit Sinha
Full-stack developer from Udaipur, India. I build complete web applications —
from REST APIs and authentication systems to responsive React frontends —
...
- **[MyBlog](https://github.com/RohitGkmit08/blog-app-frontend)** — 
  ...
  email notifications, and rich text editor. Deployed on AWS EC2.

- **[Ledger](https://github.com/RohitGkmit08/Ledger)** — 
  High-integrity double-entry bookkeeping system with atomic fund transfers,
  idempotency guarantees, immutable ledger entries, and Gmail OAuth2
  email notifications. Built with Node.js, Express, and MongoDB.

- **[Notes API](https://github.com/RohitGkmit08/notes-api)** — 
  Production-grade multi-user notes REST API with JWT auth, note sharing
  by email, full-text search, tag filtering, pagination, and OpenAPI docs.
  Deployed on Render.
